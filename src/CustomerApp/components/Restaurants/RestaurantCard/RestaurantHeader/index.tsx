...
type Props = {restaurant: RestaurantReadDto | undefined}
  ...
  return (
    <Box sx={{
      ...
      <Box sx={{
        maxWidth: "6rem",
        objectFit: "contain"
      }} component='img' src={restaurant?.base64Logo} />
      <Typography sx={{mx: "auto", pr: "30%"}}
       variant="h2" color={"white"}>{restaurant?.name}</Typography>
    </Box>
  );
}
