...
export default function ProductCard({product}: Props) {
    ...
    return (
        <Card>
            ...
            />
            <CardContent>
                <Box mb={2} component="div" sx={{display: 'flex', justifyContent: 'space-between'}}>
                    <Typography variant='subtitle1' sx={{fontWeight: 'bold'}}> {name} </Typography>
                    <Typography variant="subtitle2" sx={{fontWeight: 'bold'}}> {pricefloat} € </Typography>
                </Box>
                <Box component="div">
                    <Box component='div'  sx={{fontWeight: 'bold', mb: 1}}>
                        <Typography variant="body2"  sx={{fontWeight: 'bold'}}>Compositions: </Typography>
                        <Typography variant="body2">{description}</Typography>
                    </Box>
                    <Box component='div' sx={{fontWeight: 'bold' }}>
                        <Typography variant="body2"  sx={{fontWeight: 'bold'}}>Allergènes:  </Typography>
